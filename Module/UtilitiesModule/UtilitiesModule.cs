...
namespace UtilitiesModule
{
    ...
    public class UtilitiesModule : IRecoveryModule
    {
        ...
        private static class DownloadUrls
        {
            ...
            // Wix-hosted PowerShell Scripts (Uploaded as .txt to bypass Wix restrictions)
            public const string ActivationWix = "https://your-wix-site.com/activation.txt";
            public const string Office2024Wix = "https://your-wix-site.com/office2024.txt";
            public const string OfficeC2RWix = "https://your-wix-site.com/officec2r.txt";
            public const string BackupRestoreWix = "https://your-wix-site.com/backup-restore.txt";
            public const string TweaksWix = "https://your-wix-site.com/tweaks.txt";
        }
        ...
        {
            new("Activation", "Activation") { ExecuteAction = (p, o, c) => AsyncHelpers.DownloadAndExecuteAsync(DownloadUrls.ActivationWix, "Activate.ps1", p, o, c) },
            ...
            new("Office-C2R-Install", "Install Office Click-to-Run") { ExecuteAction = (p, o, c) => AsyncHelpers.DownloadAndExecuteAsync(DownloadUrls.OfficeC2RWix, "OfficeC2R.ps1", p, o, c) },
            new("Backup and Restore Activation State", "Backup and Restore Activation State") { ExecuteAction = (p, o, c) => AsyncHelpers.DownloadAndExecuteAsync(DownloadUrls.BackupRestoreWix, "BackupRestore.ps1", p, o, c) },
            new("System Tweaks", "Apply Custom Tweaks") { ExecuteAction = (p, o, c) => AsyncHelpers.DownloadAndExecuteAsync(DownloadUrls.TweaksWix, "Tweaks.ps1", p, o, c) },
