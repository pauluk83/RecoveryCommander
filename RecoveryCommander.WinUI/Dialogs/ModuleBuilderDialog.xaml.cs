...
/// <summary>
/// Module Builder dialog - generates C# IRecoveryModule scaffold code from a template.
/// </summary>
public sealed partial class ModuleBuilderDialog : ContentDialog
{
    private string _lastGeneratedCode = string.Empty;

    public ModuleBuilderDialog()
    {
        InitializeComponent();
    }
...
";
    ...
    private async void SaveButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var openDialog = new ContentDialog
            {
                Title = "Saved",
            ...
            if (await openDialog.ShowAsync() == ContentDialogResult.Primary)
