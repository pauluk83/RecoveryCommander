...
/// <summary>
/// Restore Point Manager dialog - view, create, restore and delete system restore points.
/// </summary>
public sealed partial class RestorePointManagerDialog : ContentDialog
{
    public RestorePointManagerDialog()
    {
        InitializeComponent();
        Loaded += async (_, _) => await LoadRestorePointsAsync();
    }
